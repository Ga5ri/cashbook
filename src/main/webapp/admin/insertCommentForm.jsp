                        ...
                        <form action="<%=request.getContextPath()%>/help/updateHelpAction.jsp" method="post" class="md-float-material">
                            ...
                            <div class="auth-box">   
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">문의사항 답변 입력</h3>
                                    </div>
                                </div>
                                <hr/>
                               <table class="table table-bordered">		
                               	<tr>
													...
													<tr>
														<td class="ct">문의내용</td>
														<td><textarea rows="3" cols="50" name="helpMemo" readonly="readonly"><%=help.get("helpMemo")%></textarea></td>
													</tr>		
													<tr>
														<td class="ct">답변작성</td>
														<td><textarea rows="3" cols="50" name="commentMemo"></textarea></td>
													</tr>													                                              
                                                </table>
                                                <div class="col-sm-12">
                                                <button type="submit" class="btn btn-md btn-primary rounded text-center" style="width: 100px;">답변추가</button>
                                                </div>
                                <hr/>
                                <div class="row">
                                    <div class="col-md-8">
